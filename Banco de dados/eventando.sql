...
INSERT INTO USUARIO (nome, data_nasc, senha, FK_ESTADO_id_estado)
VALUES
...
INSERT INTO EVENTO (objetivo, data_prevista, atracoes, privacidade_restrita, horario, nome, FK_USUARIO_id_usuario)
VALUES
...
INSERT INTO EVENTO_ONLINE (link, FK_plataforma_plataforma_PK, FK_EVENTO_id_evento)
VALUES
...
INSERT INTO LOCALIZACAO (numero, logradouro, cep, FK_TIPO_LOGRADOURO_id_tipo_logradouro, FK_BAIRRO_id_bairro)
VALUES
    (1, ' A', '12345-678', 1, 1),
    (2, ' B', '98765-432', 5, 4),
    (3, ' C', '54321-876', 3, 7),
...
INSERT INTO EVENTO_PRESENCIAL (FK_buffet_buffet_PK, FK_EVENTO_id_evento, FK_LOCALIZACAO_id_localizacao)
VALUES 
   (1, 1, 1),
   (1, 2, 2),
   (2, 3, 3),
